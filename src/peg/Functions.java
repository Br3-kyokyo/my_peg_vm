...
public class Functions {
     ...
     * function. Since I have to do the damn thing myself, I might as well make it
     * halfway useful by supporting things Java was too stupid to consider in
     * strings:
     * 
     ...
     * doublebackslashing is a Java idiocy I desperately wish would die out. There
     * are plenty of other ways to write it:
     *
     ...
     *
     * Perl hex escapes: !\x{XXX} braced may be 1-8 xdigits NB: proper Unicode never
     * needs more than 6, as highest valid codepoint is 0x10FFFF, not maxint
     * 0xFFFFFFFF
     *
     * Lame Java escape: \[IDIOT JAVA PREPROCESSOR]uXXXX must be exactly 4 xdigits;
     *
     * I can't write XXXX in this comment where it belongs because the damned Java
     * Preprocessor can't mind its own business. Idiots!
     *
     * Lame Python escape: !\UXXXXXXXX must be exactly 8 xdigits
     * 
     * TODO: Perl translation escapes: \Q \U \L \E \[IDIOT JAVA PREPROCESSOR]u \l
     * These are not so important to cover if you're passing the result to
     * Pattern.compile(), since it handles them for you further downstream. Hm, what
     * about \[IDIOT JAVA PREPROCESSOR]u?
     *
     */
    ...
    /*
     * Return a string "U+XX.XXX.XXXX" etc, where each XX set is the xdigits of the
     * logical Unicode code point. No bloody brain-damaged UTF-16 surrogate crap,
     * just true logical characters.
     */
